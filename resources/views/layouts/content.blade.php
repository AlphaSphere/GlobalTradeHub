        ...
        @php
            $category->sites()->chunk(4, function($sites){
                ...
                foreach($sites as $site){
                    echo <<<EOF
                    <div class="col-sm-3">
                        <div class="xe-widget xe-conversations box2 label-info" onclick="window.location.href='/site/$site->id'" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="$site->url">
                            <div class="xe-comment-entry">
                                <a class="xe-user-img">
                                    <img src="/uploads/$site->thumb" class="img-circle" width="40">
                                </a>
                                <div class="xe-comment">
                                    <a href="/site/$site->id" class="xe-user-name overflowClip_1">
